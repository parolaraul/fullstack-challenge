...
export class ExportImportService {
    ...
    createExport(exportRequest: ExportDto): ExportDto {
        ...
        this.logger.log('export request created and scheduled for processing', exportRequest.bookId)
    ...
    createImport(importRequest: ImportDto): ImportDto {
        ...
        this.logger.log('import request created and scheduled for processing', importRequest.bookId)
    ...
    private executeExport(exportRequest: ExportDto): Promise<ExportDto> {
        ...
        return new Promise((resolve) => setTimeout(() => {
            this.logger.log('export task finished successfully with id: ' + exportRequest.bookId);
    ...
    private executeImport(importRequest: ImportDto): Promise<ImportDto> {
        ...
        this.logger.log('starting export task with ' + duration + 'ms');
        return new Promise((resolve) => setTimeout(() => {
            this.logger.log('import task finished successfully with id: ' + importRequest.bookId);
